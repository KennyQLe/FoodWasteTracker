...
void SerializeFoodWastageRecordToJSON(
  ...
  wastage_reason = record.GetWastageReason();
...
crow::json::wvalue FoodWastageReportToCrowJSON(
  ...
  most_common_disposal_mechanisms = report.GetMostMechanisms();
  ...
  most_commonly_wasted_foods = report.GetNames();
  for (std::string randomname : most_commonly_wasted_foods) {
  ...
  // in the vector declared above.
  most_common_wastage_reasons = report.GetMostReasons();
  ...
  // result in the vector declared above.
  most_costly_waste_producing_meals = report.GetMostCost();
  ...
  suggested_strategies_to_reduce_waste = report.GetStrategies();
...
bool FoodWastageTrackerBackend::LoadRecordsFromJSONFile() {
  ...
  for (rapidjson::Value::ConstValueIterator itr = doc.Begin(); itr != doc.End();
    ...
    // adds a `record`.
    foodwastagetracker_.AddRecords(record);
  }
...
bool FoodWastageTrackerBackend::WriteRecordsToJSONFile() const {
  ...
  records = foodwastagetracker_.GetRecords();
...
crow::json::wvalue FoodWastageTrackerBackend::AddRecord(
  ...
  add_result = foodwastagetracker_.AddRecords(record);
...
crow::json::wvalue FoodWastageTrackerBackend::DeleteRecord(
  ...
  delete_result = foodwastagetracker_.DeleteRecords(record);
...
crow::json::wvalue FoodWastageTrackerBackend::GetFoodWastageReport() const {
  ...
  generated_report = foodwastagetracker_.GetFoodWastageReport();
